...
window.tests_egep5 = {
  ...
  renderizarFuncionamiento() {
    ...
    this.funcionamientoDefinitions.forEach((def, indice) => {
      ...
      html += `<div class="functioning-item"><label class="checkbox-item"><input type="checkbox" name="item_${numero}" onchange="window.tests_egep5.cambiarFuncionamiento(${indice}, this.checked)"><strong style="color: #60a5fa !important; font-weight: 700; font-size: 15px; margin-right: 4px;">${numero}.</strong><span style="text-transform: capitalize;">${def}</span></label></div>`;
    });
