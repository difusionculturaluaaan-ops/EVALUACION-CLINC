...
window.tests_mbi = {
  ...
  async cargarDesdePrueba(pruebaId, token) {
    try {
      ...
      if (metadatos) {
        if (document.getElementById('m_nombre')) document.getElementById('m_nombre').value = metadatos.paciente_nombre || '';
        if (document.getElementById('m_edad')) document.getElementById('m_edad').value = metadatos.edad || '';
        if (document.getElementById('m_sexo')) document.getElementById('m_sexo').value = metadatos.sexo || '';
        if (document.getElementById('m_centro')) document.getElementById('m_centro').value = metadatos.centro || '';
        if (document.getElementById('m_evaluador')) document.getElementById('m_evaluador').value = metadatos.evaluador || '';
        if (document.getElementById('m_fecha')) document.getElementById('m_fecha').value = metadatos.fecha_evaluacion || '';
      }
  ...
  guardarEnExpediente() {
    ...
    setTimeout(() => {
      ...
      // Mantener ventana abierta para exportar JSON y descargar PDF
      // setTimeout(() => {
